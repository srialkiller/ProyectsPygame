...
class Game:
    ...
    def update(self):
        ...
        if coin:
            ...
            sound = pygame.mixer.Sound(os.path.join(self.dir_sounds, 'coin-drop-1.wav'))
            sound.play()
    ...
    def stop(self):
        sound = pygame.mixer.Sound(os.path.join(self.dir_sounds, 'drip2.wav'))
        sound.play()
        self.player.stop()
    ...
    def draw_text(self):
        ...
        self.display_text(self.level_format(), 36, WHITE, WIDTH // 10, TEXT_POSY)
    ...
    def menu(self):
        ...
        self.display_text('Presione una tecla para comenzar', 36, BLACK, WIDTH // 2, 10)
